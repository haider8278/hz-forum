	...
	class Hz_Forum_View {
		...
		public function render( $filename = '', array $vars = array() ) {
			...
			if ( false === is_admin() &&
				...
				$template_names[] = 'hz-forum_' . $filename . self::EXT;
				$template_names[] = 'hz-forum/' . $filename . self::EXT;
			...
			$filepath = apply_filters( 'hz_timeline_view_file', $filepath );
