...
class Hz_Timeline_Elementor_Widget extends Elementor\Widget_Base {
	...
	public function get_shortcode( $name ) {
		...
		if ( ! isset( hz_timeline_elementor_compat()->shortcodes[ $this->get_name() ] ) ) {
			return;
		}

		$shortcode = wp_parse_args( hz_timeline_elementor_compat()->shortcodes[ $this->get_name() ], array(
			'title' => null,
	...
	public function get_name() {
		return Hz_Timeline::get_shortcode_tag();
	}
